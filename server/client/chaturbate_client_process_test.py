...
def mock_chaturbate_client():
    ...
    with patch("server.client.chaturbate_client_process.ChaturbateClient") as mock_class:
...
class TestChaturbateClientProcessInitialization:
    ...
    def test_initialization_with_custom_event_handler(self, mock_event_handler, clean_env):
...
class TestChaturbateClientProcessIntegration:
    ...
    @pytest.mark.asyncio
    async def test_full_lifecycle_with_events(self, mock_chaturbate_client, mock_event_handler, clean_env):
