...
write_request_model = api.model('WriteRequest', {
    'style': fields.String(required=True, description='Writing style (e.g., formal, creative, technical)'),
    'text': fields.String(required=True, description='Topic or subject to write about'),
    'to_lang': fields.String(required=True, description='Target language for the generated content')
})

write_response_model = api.model('WriteResponse', {
